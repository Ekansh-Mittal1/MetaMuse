...
async def run_workflow(
    ...
    **kwargs
    ...
    # Handle batch_samples_efficient workflow
...
Examples:
  ...
  python main.py batch_samples_efficient "sample_count=100 conditional_mode=eval max_iterations=3"
  ...
  python main.py deterministic_sql "GSM1000981,GSM1000984 target_field:tissue"
