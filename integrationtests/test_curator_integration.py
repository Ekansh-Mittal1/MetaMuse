...
class TestCuratorIntegration:
    ...
    def test_disease_curation_dlbcl_samples(self):
        ...
        for sample_id in ["GSM1000981", "GSM1000984"]:
            ...
            extract_result = tools.extract_metadata_candidates(
                load_result.data, "Disease"
            )
            ...
            assert (
                reconcile_result.data["reconciliation_status"]
    ...
    def test_multiple_samples_consensus(self):
        ...
        sample1_candidate = (
            results_by_sample["GSM1000981"].get("final_candidate", "").lower()
        )
        sample2_candidate = (
            results_by_sample["GSM1000984"].get("final_candidate", "").lower()
        )
