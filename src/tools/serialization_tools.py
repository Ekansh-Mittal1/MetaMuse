...
class SerializationTools:
    ...
    def serialize_ingestion_output(
        ...
        metadata_objects: Dict[str, Union[GSMMetadata, GSEMetadata, PMIDMetadata]] = None,
    ...
    def serialize_linker_output(
        ...
        cleaned_metadata: Dict[str, List[Union[GSMMetadata, GSEMetadata, PMIDMetadata]]] = None
    ) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            if linked_data_objects:
                for sample_id, linked_data in linked_data_objects.items():
                    linked_file = self.model_serializer.serialize_linked_data(linked_data)
...
def serialize_linker_output_impl(
    ...
    try:
        ...
        return tools.serialize_linker_output(output, typed_linked_data, typed_cleaned_metadata)
